          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
            <div className="lg:col-span-7 z-10 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Link to="/contact" className="border border-outline-variant text-primary px-8 py-4 rounded-lg font-headline-sm text-base font-semibold hover:border-secondary transition-all hover:bg-white/40 inline-flex items-center justify-center">
                  Request Demo
                </Link>
              </div>
            </div>
        ...
        <section className="py-24 px-6 md:px-12 bg-surface-container-low border-y border-outline-variant/60">
          <div className="max-w-7xl mx-auto space-y-16">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8">
              ...
              <Link to="/process" className="bg-white border border-outline-variant/80 px-6 py-3 rounded-lg font-label-caps text-xs tracking-wider uppercase font-semibold hover:border-secondary transition-all hover:bg-surface duration-200">
        ...
        <section className="py-24 px-6 md:px-12 text-center bg-white overflow-hidden relative">
          ...
          <div className="max-w-3xl mx-auto relative z-10 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/contact" className="border border-outline text-primary px-8 py-4 rounded-lg font-headline-sm text-base font-semibold hover:border-secondary transition-all hover:bg-surface duration-200 inline-flex items-center justify-center">
